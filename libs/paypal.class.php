...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      $pastepay = "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      $pastepay .= "<center><h2>Please wait, your order is being processed and you";
      $pastepay .= " will be redirected to the paypal website.</h2></center>\n";
      $pastepay .= "<form method=\"post\" name=\"paypal_form\" ";
      $pastepay .= "action=\"".$this->paypal_url."\">\n";

      foreach ($this->fields as $name => $value) {
        $pastepay .= "<input type=\"hidden\" name=\"$name\" value=\"$value\"/>\n";
      }
      $pastepay .= "<center><br /><br/>If you are not automatically redirected to ";
      $pastepay .= "paypal within 5 seconds...<br /><br />\n";
      $pastepay .= "<input type=\"submit\" value=\"Click Here\"></center>\n";      
      $pastepay .= "</form>\n";    
      return $pastepay;
   }
   ...
   function validate_ipn() {
      ...
      $fp = fsockopen ('ssl://www.paypal.com', '443', $err_num, $err_str, 30); // Fix paypal ssl
      if(!$fp) {
